...
export default function AdminDashboard() {
  ...
  const getQuickActions = (userRole: string) => {
    const baseActions = [
      { name: 'Neues Ticket', href: '/portal/tickets/new', icon: Plus, roles: ['USER', 'MANAGER', 'ADMIN'] },
      { name: 'Projekte anzeigen', href: '/portal/projects', icon: Eye, roles: ['USER', 'MANAGER', 'ADMIN'] },
      { name: 'Aufgaben anzeigen', href: '/portal/tasks', icon: Eye, roles: ['USER', 'MANAGER', 'ADMIN'] },
    ]
    ...
    if (userRole === 'ADMIN') {
      baseActions.push(
        { name: 'Neuer Benutzer', href: '/portal/users/new', icon: Plus, roles: ['ADMIN'] },
